...
Page({
  ...
  pullUpLoad () {
    ...
    api.get(api.ITEMS + '?last_id=' + this.data.hot_last_id)
      .then(res => {
        this.setData({
          list: this.data.list.concat(res.data.data.items),
          hot_last_id: res.data.data.last_id
        })
  ...
  pullUpLoadLatest () {
    ...
    //   .then(res => {
    //     this.setData({
    //       latest_list: this.data.latest_list.concat(res.data.data.items),
